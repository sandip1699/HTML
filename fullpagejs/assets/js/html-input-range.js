...
let htmlInputRange = {
  ...
  options (inputs) {
    ...
    if (options.tooltip === true) {
      ...
      $('input[type=range]').parent().append('<div class="tooltips">'+ min +'"</div>');
    }
  }
}
